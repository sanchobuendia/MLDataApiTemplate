...
if __name__ == '__main__':
    ...
    src_template = '{}/MLDataApiTemplate/templates/src'.format(os.path.dirname(PROJECT_DIRECTORY))
    ...
    shutil.copy2('{}/MLDataApiTemplate/.gitignore'.format(os.path.dirname(PROJECT_DIRECTORY)), '{}/.gitignore'.format(PROJECT_DIRECTORY))

    print('COPY github actions')
    github_template = '{}/MLDataApiTemplate/templates/.github'.format(os.path.dirname(PROJECT_DIRECTORY))
    github_target = '{}/.github'.format(PROJECT_DIRECTORY)
    shutil.copytree(github_template, github_target)

    print('COPY test directory')
    test_template = '{}/MLDataApiTemplate/templates/test'.format(os.path.dirname(PROJECT_DIRECTORY))
    ...
    modules_template = '{}/MLDataApiTemplate/templates/src/modules'.format(os.path.dirname(PROJECT_DIRECTORY))
    ...
    routes_template = '{}/MLDataApiTemplate/templates/src/routes'.format(os.path.dirname(PROJECT_DIRECTORY))
    ...
    libraries_template = '{}/MLDataApiTemplate/templates/src/libraries'.format(os.path.dirname(PROJECT_DIRECTORY))
    ...
    if '{{ cookiecutter.use_database }}' == 'yes':
        ...
        db_template = '{}/MLDataApiTemplate/templates/db'.format(os.path.dirname(PROJECT_DIRECTORY))
        db_target = '{}/db'.format(PROJECT_DIRECTORY)
        shutil.copytree(db_template, db_target)

        print('COPY .env')
        shutil.copy2('{}/MLDataApiTemplate/templates/.env.db.dev'.format(os.path.dirname(PROJECT_DIRECTORY)), '{}/.env'.format(PROJECT_DIRECTORY))

        print('COPY docker-compose')
        shutil.copy2('{}/MLDataApiTemplate/templates/docker-compose-db.yml'.format(os.path.dirname(PROJECT_DIRECTORY)), '{}/docker-compose.yml'.format(PROJECT_DIRECTORY))
        ...
        models_template = '{}/MLDataApiTemplate/templates/src/models'.format(os.path.dirname(PROJECT_DIRECTORY))
        models_target = '{}/src/models'.format(PROJECT_DIRECTORY)
        shutil.copytree(models_template, models_target)
    else:
        print('COPY .env')
        shutil.copy2('{}/MLDataApiTemplate/templates/.env.dev'.format(os.path.dirname(PROJECT_DIRECTORY)), '{}/.env'.format(PROJECT_DIRECTORY))

        print('COPY docker-compose')
        shutil.copy2('{}/MLDataApiTemplate/templates/docker-compose.yml'.format(os.path.dirname(PROJECT_DIRECTORY)), '{}/docker-compose.yml'.format(PROJECT_DIRECTORY))
